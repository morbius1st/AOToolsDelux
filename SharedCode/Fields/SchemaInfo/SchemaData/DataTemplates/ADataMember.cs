...
namespace SharedCode.Fields.SchemaInfo.SchemaData.DataTemplate
{
	...
	#region data fields
		...
		public abstract IFieldsMembers<TE> FieldsMembers { get; protected set; }
	...
	#region public methods
		...
		public string this[DataColumns Id]
		{
			get
			{
				...
				case DataColumns.NAME:         { return FieldsMembers.Name;}
				case DataColumns.VALUE_STR :   { return ValueString;}
				case DataColumns.VALUE_TYPE :  { return ValueType.ToString();}
				case DataColumns.FIELDS_TEMP : { return FieldsMembers.ToString();}
				}
				return null;
			}
		}
