...
using static CSToolsDelux.Fields.ExStorage.ExStorManagement.ExStoreStartRtnCodes;
using static CSToolsDelux.Fields.ExStorage.ExStorManagement.ExStoreRtnCodes;
using static CSToolsDelux.Fields.ExStorage.ExStorManagement.ExStoreSelectDsRtnCodes;
...
namespace CSToolsDelux.Fields.Testing
{
	public static class SampleData
	{
		...
		private static void sayResult(string result, int location, int itemIndex)
		{
			...
			W.WriteLineAligned($"at {ti[itemIndex].routine}  ({ti[location].routine})", $"=> {result}  ({ti[itemIndex].description})");
