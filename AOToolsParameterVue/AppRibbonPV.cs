...
{
	class AppRibbonPV : IExternalApplication
	{
		// application: launch with revit - setup interface elements
		// display information

		private const string NAMESPACE_PREFIX = "AOToolsParameterVue.Resources";

		private const string PANEL_NAME = "Pram Vue";
		private const string TAB_NAME = "AO Tools";

		private static string AddInPath = typeof(AppRibbonPV).Assembly.Location;
		private const string CLASSPATH = "AOToolsParameterVue.";
