...
namespace Tests01
{
	internal class AppRibbon : IExternalApplication
	{
		...
		private const string NAMESPACE_PREFIX = "Tests01.Assets";

		private const string PANEL_NAME = "Tests01";
		private const string TAB_NAME = "AO Tools";

		private const string BUTTON_NAME = "Tests01";
		private const string BUTTON_TEXT = "Tests01";
		...
		private const string CLASSPATH = "Tests01.";
