...
// username: jeffs
// created:  9/17/2023 4:25:36 PM

namespace CsDeluxMeasure.Windows.Support
{
	public static class WindowUtilities
	{
		public static Rectangle GetWinPositionScreenCenter(Window me, Window parent)
		{
			Rectangle screen = WindowApiUtilities.GetScaledScreenSize(parent);

			int x = (int) (screen.Width / 2 - me.Width / 2);
			int y = (int) (screen.Height / 2 - me.Height / 2);

			// height and width do not matter
			return new Rectangle(x, y, 0, 0);


		}

		public static Rectangle GetWinPositionWinCenter(Window me, Window parent)
		{
			int x = (int) (parent.Left + parent.Width / 2 - me.Width / 2);
			int y = (int) (parent.Top + parent.Height / 2 - me.Height / 2);
		...
		public static Rectangle GetWinPositionScreenOffset(Window me, int offsetX, int offsetY)
		{
			int x = offsetX;
			int y = offsetY;
		...
		public static Rectangle GetWinPositionWinOffset(Window me, Window parent, int offsetX, int offsetY)
		{
			int x = (int) (parent.Left + offsetX);
			int y = (int) (parent.Top + offsetY);
	...
	public class WindowApiUtilities
	{
