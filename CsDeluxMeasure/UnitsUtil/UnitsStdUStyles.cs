...
namespace CsDeluxMeasure.UnitsUtil
{
	public struct STYLE_DATA
	{
		...
		public static readonly STYLE_DATA FtDecIn            = new STYLE_DATA("Custom"              , "Feet and Decimal Inches"   , ""       , INLIST_DISABLED,  102,  109);
		public static readonly STYLE_DATA FtFracIn           = new STYLE_DATA("FeetFractionalInches", "Feet and Fractional Inches", ""       ,  102,  108,  104);
		public static readonly STYLE_DATA UsSurvey           = new STYLE_DATA("UsSurveyFeet"        , "Survey Feet"               , "USFt"   , INLIST_UNDEFINED, INLIST_UNDEFINED, INLIST_UNDEFINED);
		public static readonly STYLE_DATA Feet               = new STYLE_DATA("Feet"                , "Decimal Feet"              , "\'"     ,  107,  104,  101);
		public static readonly STYLE_DATA DecInches          = new STYLE_DATA("Inches"              , "Decimal Inches"            , "\""     ,  101,  101,  102);
		public static readonly STYLE_DATA FracInches         = new STYLE_DATA("FractionalInches"    , "Fractional Inches"         , "\""     ,  104, INLIST_UNDEFINED, INLIST_UNDEFINED);
		public static readonly STYLE_DATA Meters             = new STYLE_DATA("Meters"              , "Meters"                    , "m"      , INLIST_UNDEFINED, INLIST_UNDEFINED, INLIST_UNDEFINED);
		public static readonly STYLE_DATA Decimeters         = new STYLE_DATA("Decimeters"          , "Decimeters"                , "dm"     , INLIST_UNDEFINED, INLIST_UNDEFINED, INLIST_UNDEFINED);
		public static readonly STYLE_DATA Centimeters        = new STYLE_DATA("CentiMeters"         , "CentiMeters"               , "cm"     , INLIST_UNDEFINED, INLIST_UNDEFINED, INLIST_UNDEFINED);
		public static readonly STYLE_DATA Millimeters        = new STYLE_DATA("MilliMeters"         , "MilliMeters"               , "mm"     , INLIST_UNDEFINED, INLIST_UNDEFINED, INLIST_UNDEFINED);
	...
	public class UnitsStdUStyles
	{
		...
		private static void addStandard()
		{
			...
			StdSysStyles.Add(STYLE_DATA.FtFracIn.NameId, 
				new UStyle(UnitClass.CL_ORDINARY, // locked
			...
			name = "Millimeters";
			StdSysStyles.Add(STYLE_DATA.Millimeters.NameId, 
				new UStyle(UnitClass.CL_ORDINARY,
			...
			StdSysStyles.Add(STYLE_DATA.MetersCentimeters.NameId, 
				new UStyle(UnitClass.CL_ORDINARY,
